...
@set XCPYOPT=/y /s /f
@xcopy "%KRXIMPEXP_INTERMEDIATE%\BpyImpExp\Krx%1.py" "%BLENDER_DIR%\%BLENDER_SHORTVER%\scripts\addons\KrxImpExp\" %XCPYOPT%
@xcopy "%KRXIMPEXP_INTERMEDIATE%\BpyImpExp\Krx%1.py" "%KRXIMPEXP_INSTALL%\blender\%BLENDER_SHORTVER%\scripts\addons\KrxImpExp\" %XCPYOPT%
