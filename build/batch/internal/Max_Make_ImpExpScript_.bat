...
@set XCPYOPT=/y /s /f	
@xcopy "%KRXIMPEXP_INTERMEDIATE%\MaxScriptImpExp\Krx%1.ms" "%MAXDIR_5%\scripts\" %XCPYOPT%
@xcopy "%KRXIMPEXP_INTERMEDIATE%\MaxScriptImpExp\Krx%1.ms" "%MAXDIR_6%\scripts\" %XCPYOPT%
@xcopy "%KRXIMPEXP_INTERMEDIATE%\MaxScriptImpExp\Krx%1.ms" "%MAXDIR_9%\scripts\" %XCPYOPT%
@xcopy "%KRXIMPEXP_INTERMEDIATE%\MaxScriptImpExp\Krx%1.ms" "%MAXDIR_9_X64%\scripts\" %XCPYOPT%
@xcopy "%KRXIMPEXP_INTERMEDIATE%\MaxScriptImpExp\Krx%1.ms" "%MAXDIR_11%\scripts\" %XCPYOPT%
@xcopy "%KRXIMPEXP_INTERMEDIATE%\MaxScriptImpExp\Krx%1.ms" "%MAXDIR_11_X64%\scripts\" %XCPYOPT%
@xcopy "%KRXIMPEXP_INTERMEDIATE%\MaxScriptImpExp\Krx%1.ms" "%MAXDIR_12%\scripts\" %XCPYOPT%
@xcopy "%KRXIMPEXP_INTERMEDIATE%\MaxScriptImpExp\Krx%1.ms" "%MAXDIR_12_X64%\scripts\" %XCPYOPT%
@xcopy "%KRXIMPEXP_INTERMEDIATE%\MaxScriptImpExp\Krx%1.ms" "%MAXDIR_14%\scripts\" %XCPYOPT%
@xcopy "%KRXIMPEXP_INTERMEDIATE%\MaxScriptImpExp\Krx%1.ms" "%MAXDIR_14_X64%\scripts\" %XCPYOPT%
@xcopy "%KRXIMPEXP_INTERMEDIATE%\MaxScriptImpExp\Krx%1.ms" "%MAXDIR_15%\scripts\" %XCPYOPT%
@xcopy "%KRXIMPEXP_INTERMEDIATE%\MaxScriptImpExp\Krx%1.ms" "%MAXDIR_15_X64%\scripts\" %XCPYOPT%
